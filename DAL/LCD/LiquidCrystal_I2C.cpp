...
extern void delayMicroseconds( int delay );
...
void LiquidCrystal_I2C::expanderWrite(uint8_t _data){
	...
	unsigned char c[1];
	c[0] = _data | _backlightval;
	peripheral::i2c::write(0x27u, &c[0], 1u );
}
...
void LiquidCrystal_I2C::printstr( char * c, unsigned int tsize){
