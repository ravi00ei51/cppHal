...
static struct dmp_s dmp = {
    .tap_cb = (void (*)(unsigned char, unsigned char))NULL,
    .android_orient_cb = (void (*)(unsigned char))NULL,
    .orient = 0,
    .feature_mask = 0,
    .fifo_rate = 0,
    .packet_length = 0
...
int dmp_set_orientation(unsigned short orient)
{
    ...
    memcpy((void *)gyro_regs, (void *)gyro_sign, 3);
    memcpy((void *)accel_regs, (void *)accel_sign, 3);
    if (orient & 4) {
        gyro_regs[0] |= 1;
        accel_regs[0] |= 1;
    }
